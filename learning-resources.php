...
<body>
    ...
    ?>
    <main>
        <h2>Rules Governing the <span class="alt-col"> Use of the Resource Services</span></h2>
        <div class='content'>
            <h3><span class="alt-col">Introduction</span></h3>
            <p>
            ...
            <p>
                Membership may also be extended to other individuals and to persons nominated from other organisations:  a fee is usually charged.  Access to the Learning Resources for study purposes may be made available to non-members by arrangement. Details are available in the <span class="italic-bold">External Services</span> leaflet.
            </p>
            <p>
            ...
            <p>
                Breaches of the rules may be dealt with by specific Learning Resources Disciplinary Action (see below), including the withdrawal of some or all Learning Resources facilities, and if appropriate by invoking the College's <a href="info-for-students.php">Regulations for Students</a>, in the case of students, or in the case of staff through the appropriate College procedures as set out in the <a href="info-for-staff.php">Staff Handbook.</a> 
            </p>
        </div>
        <div class="splitter"></div>
        <div id="rules" class="content">
            <h2><span class="alt-col">Rules</span></h2>
            <div id="access">
                <h3>Access:</h3>
                <ol>
                    ...
                    <li>Individuals or organisations who are not eligible for membership but have good reason to use the Learning Resources  may be admitted, by arrangement, for purposes of study only. Procedures for seeking admission are outlined in the <span class="italic-bold">External Services</span> leaflet. Non-members must sign the Visitors' Book on each visit, and may be required to produce written identification.  Study use does not include access to the College's Academic Network.</li>
                ...
                <p id="comment">Users of the Learning Resources are reminded that they must be willing to show  ID cards or other identification when requested to do so by College staff.</p>
            </div>
            <div class="splitter"></div>
            <div id="use-of-facilities">
                ...
                <ol>
                    ...
                    <li>Mobile phones must be turned off in all Learning Resources study areas. Their use is permitted in the <span class="italic-bold">enclosed</span> stair wells of the Main Site building.  Circumstances at the Clinical Site Libraries may vary.</li>
